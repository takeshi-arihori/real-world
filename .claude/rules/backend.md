...
> **ドメイン設計仕様の参照**
> - Bounded Context 定義: [`docs/arch/bounded-contexts.md`](../docs/arch/bounded-contexts.md)
> - ユビキタス言語定義: [`docs/arch/ubiquitous-language.md`](../docs/arch/ubiquitous-language.md)
